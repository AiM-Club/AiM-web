...
const InviteContent = () => {
  ...
  return (
    <S.InviteContentWrapper $wrap={wrapperWidth <= 865} ref={setContentElement}>
      <S.LeftWrapper>
        <ProfileImage width={wrapperWidth > 480 ? 4 : 3} image="https://media1.giphy.com/media/v1.Y2lkPTc5MGI3NjExaGlwMHl4dXFnOHlxcW5hNzNiZ2V0bXczMXdhOXdmY3dsc3M2dDhiNCZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/3Ky1RlGqJN4xadIyRW/giphy.gif" />
        ...
        {wrapperWidth > 480 ? <S.Title>제목 최대 15자</S.Title> : <></>}
      </S.LeftWrapper>
      <S.RightWrapper $wrap={wrapperWidth <= 865}>
        {wrapperWidth <= 865 && wrapperWidth > 480 ?
          ...
          : <S.LevelWrapper><S.Title>제목최대자제목최대자제목최대앙</S.Title></S.LevelWrapper>}
